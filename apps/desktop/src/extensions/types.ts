 ...
 *   webDetailPage: "https://danielshue.github.io/torqena-extensions/agents/daily-journal-helper",
 *   packageContents: [{
 ...
 * This is the actual JSON structure from danielshue.github.io/torqena-extensions.
 */
 ...
 * Stored in .obsidian/torqena-extensions.json for each installation.
 * 
 * @example
 * ```typescript
...
export function transformRawExtension(raw: RawCatalogExtension): MarketplaceExtension {
	return {
		...
		webDetailPage: raw.detailPageUrl || `https://danielshue.github.io/torqena-extensions/extensions/${raw.type}s/${raw.id}/`,
