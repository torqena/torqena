 ...
 *
 * const analytics = new ExtensionAnalyticsService('https://torqena-api.purpleocean-69a206db.eastus.azurecontainerapps.io');
...
export class ExtensionAnalyticsService {
     ...
     *
     * @param baseUrl - Root URL of the analytics API (e.g. `https://torqena-api.purpleocean-69a206db.eastus.azurecontainerapps.io`).
