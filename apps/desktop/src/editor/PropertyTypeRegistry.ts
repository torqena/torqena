 ...
 * Supports user-specified type overrides persisted to `.torqena/types.json`.
...
const OVERRIDES_FOLDER = ".torqena";
const OVERRIDES_FILE = ".torqena/types.json";
...
export class PropertyTypeRegistry {
	...
	/**
	 * Load user type overrides from `.torqena/types.json`.
	 *
	...
	/**
	 * Save user type overrides to `.torqena/types.json`.
	 */
