...
export async function validateExtensionId(extensionId: string): Promise<ExtensionIdValidationResult> {
	...
	try {
		const catalogUrl = "https://raw.githubusercontent.com/danielshue/torqena-extensions/main/catalog/catalog.json";
...
export async function fetchPreviousExtensionData(
	...
	const baseUrl = "https://raw.githubusercontent.com/danielshue/torqena-extensions/main/extensions";
