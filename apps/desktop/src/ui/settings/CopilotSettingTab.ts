...
export const COPILOT_SETTINGS_TABS: ReadonlyArray<CopilotSettingsTabDescriptor> = [
	{ id: "torqena-datetime", name: "Date & time", icon: "calendar-clock", section: "date-time" },
	{ id: "torqena-periodic-notes", name: "Periodic notes", icon: "notebook-pen", section: "periodic-notes" },
	{ id: "torqena-profiles", name: "AI Providers", icon: "bot", section: "ai-provider-profiles" },
	{ id: "torqena-chat", name: "Chat Preferences", icon: "message-square", section: "chat-preferences" },
	{ id: "torqena-whisper", name: "Whisper.cpp", icon: "mic", section: "whisper-cpp", requiresDesktop: true },
	{ id: "torqena-voice", name: "Voice input", icon: "audio-lines", section: "voice-input" },
	{ id: "torqena-realtime", name: "Realtime agent", icon: "radio", section: "realtime-agent" },
	{ id: "torqena-tools", name: "Tool selection", icon: "sliders-horizontal", section: "tool-selection" },
	{ id: "torqena-skills", name: "Skills & MCP", icon: "wrench", section: "skills-mcp" },
	{ id: "torqena-automations", name: "Automations", icon: "zap", section: "automations" },
	{ id: "torqena-advanced", name: "Folder Paths", icon: "sliders-horizontal", section: "advanced-settings" },
	{ id: "torqena-connection", name: "Connection status", icon: "plug", section: "connection-status", requiresDesktop: true },
	{ id: "torqena-setup", name: "Vault setup", icon: "folder-cog", section: "vault-setup", requiresDesktop: true },
	{ id: "torqena-help", name: "Help", icon: "circle-help", section: "help" },
];
...
export class CopilotSettingTab extends PluginSettingTab {
	...
	constructor(app: App, plugin: CopilotPlugin, options?: CopilotSettingTabOptions) {
		...
		(this as unknown as { id: string }).id = options?.tabId ?? "torqena";
		(this as unknown as { name: string }).name = options?.tabName ?? "Torqena";
